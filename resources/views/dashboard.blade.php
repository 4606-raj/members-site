                ...
                @endif
                    ...
                    <form class="bg-white px-8 pt-6 pb-8 mb-4 mt-4 ml-4" method="POST" action="{{ route('members.store') }}" enctype="multipart/form-data">
                      ...
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('phone_number') }}" name="phone_number" type="number" placeholder="Phone Number" required>
                      </div>
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
